"""
Django settings for the 'example' demo project.
"""
...
SECRET_KEY = 'django-insecure-demo-key-for-example-project'
...
# Media files (for user-uploaded content like images from Editor.js)
MEDIA_URL = '/media/'
